---
name: pdf
description: "PDF creation, editing, reading, and manipulation. Use when: creating professional PDF documents, extracting text or tables from PDFs, merging or splitting PDFs, filling PDF forms, generating reports, creating structured documents with charts, or any PDF processing task."
---
...
This guide covers PDF processing operations using Python libraries. It covers reading and extracting from existing PDFs, creating new PDFs programmatically, and manipulating PDF structure.

**Primary Libraries:**
- `reportlab`  Creating professional PDFs from scratch
- `pypdf`  Reading, merging, splitting, and modifying PDFs
- `pdfplumber`  Extracting text and tables with layout preservation
...
When creating PDFs with ReportLab, register fonts before using them:
...
# Register fonts from any path on your system
pdfmetrics.registerFont(TTFont('TimesNewRoman', 'path/to/Times-New-Roman.ttf'))
pdfmetrics.registerFont(TTFont('TimesNewRoman-Bold', 'path/to/Times-New-Roman-Bold.ttf'))

# Register font family to enable <b>, <i>, <super>, <sub> tags in Paragraph objects
...
**Google Fonts** (recommended for web-quality PDFs):
```bash
# Download any Google Font
pip install fonttools
# Or download directly and pass path to TTFont
```

### CJK (Chinese/Japanese/Korean) Fonts

For documents containing CJK characters:
```python
# Option 1: Use fonts available on the system
pdfmetrics.registerFont(TTFont('NotoSansCJK', '/path/to/NotoSansCJK-Regular.ttf'))

# Option 2: Use reportlab's CJK support
...
doc = SimpleDocTemplate(
    ...
    creator="[Application or Team Name]"
)
```

#### Updating Metadata on Existing PDFs
```python
...
```python
sms3 = \\\"\\\"\\\"Hi [FIRST_NAME] 
You're invited! Join us for an exclusive first look at the Carolina Herrera Resort 2025 collectionbefore it opens to the public.
[DATE] | [TIME]
[Boutique Name]
...
You're invited! Join us for an exclusive first look at the Carolina Herrera Resort 2025 collectionbefore it opens to the public.<br/><br/>
[DATE] | [TIME]<br/>
[Boutique Name]<br/><br/>
