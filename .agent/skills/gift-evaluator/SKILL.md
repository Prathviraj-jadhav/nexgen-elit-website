---
name: gift-evaluator
description: "Gift evaluation and recommendation skill. Use when: the user wants to evaluate a gift (photo or description), find out what a gift is worth, get thank-you message suggestions, or get reciprocal gift recommendations. Integrates visual analysis, web pricing, and personalized response strategies."
---

This skill transforms the assistant into an **AI Gift Appraiser**. It bridges visual data and social context  identifying the gift, valuing it, suggesting response messages, and recommending appropriate reciprocal gifts.
