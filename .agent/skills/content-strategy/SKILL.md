...
description: "Build and execute a content marketing strategy. Use when: planning what content to create, deciding on content formats and channels, building a content calendar, measuring content performance, or systematizing content production. Covers audience research, content pillars, distribution strategy, repurposing workflows, SEO strategy, and metrics. Works for solopreneurs, agencies, startups, and enterprise teams. Trigger on: content strategy, content marketing, content plan, content calendar, content ideas, content distribution, what should I write about, grow through content."
---
...
- **Not researching audience needs**. Your assumptions are often wrong  validate with real data from communities, customers, and keyword tools.
...
- **Not repurposing**. Creating 10 original pieces is 5x harder than creating 2 original pieces and repurposing into 8 more.
- **Ignoring metrics**. If you don't measure, you can't improve. Monthly check-ins minimum.
- **Optimizing for vanity metrics**. Likes don't pay bills  track email signups, leads, sales, not just engagement.
- **Writing for search engines only**. Balance SEO intent with genuine human value; AI-generated content farms are being de-ranked in 2025.

---

## Quick Reference: Content Marketing Stack

| Tool | Category | Use |
|------|----------|-----|
| Ahrefs / SEMrush / Ubersuggest | SEO | Keyword research, competitor analysis |
| AnswerThePublic | Ideation | Find questions people ask |
| Notion / Airtable | Calendar | Content planning |
| Buffer / Hootsuite | Scheduling | Social media scheduling |
| Beehiiv / Substack / ConvertKit | Newsletter | Email list and sends |
| Canva | Design | Graphics and carousels |
| Descript | Video | Podcast/video editing |
| Google Analytics 4 | Analytics | Traffic and conversions |
| Google Search Console | SEO | Organic search performance |
