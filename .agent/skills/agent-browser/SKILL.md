---
name: agent-browser
description: "Headless browser automation skill for web interactions. Use when: automating web navigation, clicking, form filling, scraping dynamic JavaScript-rendered pages, taking page snapshots, testing web UIs, or any task requiring programmatic browser control."
---
